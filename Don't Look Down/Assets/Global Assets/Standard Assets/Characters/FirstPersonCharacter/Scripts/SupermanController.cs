...
namespace UnityStandardAssets.Characters.FirstPerson
{
	...
	public class SupermanController : MonoBehaviour
	{
		...
		[SerializeField] private float m_UpSensitivity;
		...
		private void FixedUpdate()
		{
			...
			if (m_Camera.transform.forward.y > m_UpSensitivity) {
				m_IsAntiGravity = true;
			}
			
			if (m_IsAntiGravity) {
				m_MoveDir += -1*Physics.gravity/2f*m_GravityMultiplier*Time.fixedDeltaTime;
			}
